...
X_train_gd = X_train[y_train=='gratefuldead']
tfidf_gd = document_tfidf_matrix[y_train=='gratefuldead']
nmf = NMF(n_components=10)
nmf.fit(tfidf_gd)
W = nmf.transform(tfidf_gd)
H = nmf.components_
...
lat_0_docs = X_train_gd[latent_features==0]
lat_1_docs = X_train_gd[latent_features==1]
lat_2_docs = X_train_gd[latent_features==2]
lat_3_docs = X_train_gd[latent_features==3]
lat_4_docs = X_train_gd[latent_features==4]
lat_5_docs = X_train_gd[latent_features==5]
lat_6_docs = X_train_gd[latent_features==6]
lat_7_docs = X_train_gd[latent_features==7]
lat_8_docs = X_train_gd[latent_features==8]
lat_9_docs = X_train_gd[latent_features==9]
